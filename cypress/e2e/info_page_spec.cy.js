describe('visit info page', () => {
  ...
  it('Should display the poster image of the movie', () => {
    cy.get('.movie-info-container').within(() => {
      cy.get('.info-mask').within(() => {
        cy.get('.rotating-box').within(() => {
          cy.get('.rotating-box-inner').within(() => {
            cy.get('.rotating-box-front').within(() => {
  ...
  it('Should display the title, genre, release date, rating, runtime, synopsis of the movie', () => {
    cy.get('.movie-info-container').within(() => {
      cy.get('.info-mask').within(() => {
        cy.get('.rotating-box').within(() => {
          cy.get('.rotating-box-inner').within(() => {
            cy.get('.rotating-box-back').within(() => {
